 ...
 * {@link Social.SocialInteractionListener} interface
...
public class Social extends Fragment {
    ...
    private SocialInteractionListener talkToActivity;
    ...
    public void onButtonPressed(Uri uri) {
        if (talkToActivity != null) {
            talkToActivity.onFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            talkToActivity = (SocialInteractionListener) activity;
        } catch (ClassCastException e) {
            throw new ClassCastException(activity.toString()
                    + " must implement SocialInteractionListener");
        }
    }
